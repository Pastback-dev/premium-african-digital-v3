...
import EvaluationDetailsForm from '@/components/EvaluationDetailsForm'; // Import the new component
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            {selectedEvaluation ? (
              <EvaluationDetailsForm evaluation={selectedEvaluation} onUpdate={fetchEvaluations} />
            ) : (
              <Card className="p-6 sm:p-8 lg:p-10 text-center flex items-center justify-center min-h-[500px]">
                <p className="text-muted-foreground text-lg">Select an evaluation from the left to view details.</p>
              </Card>
            )}
          </div>
        </div>
